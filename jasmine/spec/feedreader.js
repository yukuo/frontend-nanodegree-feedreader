    ...
    */
    ...
    describe('The Menu', function() {
         ...
         */
          ...
          */
          it('display is toggled after clicking', function() {
            menuIcon.click();
    ...
    describe('Initial Entries', function() {
         ...
         */
         ...
         it('should load the feed and there is at least one entry', function() {
    ...
    describe('New Feed Selection', function() {
         ...
         */
         ...
         it('should load new feed content', function(done) {
           ...
           expect(newFeedHtml).not.toBe(currentFeedHtml);
           done();
         });
    });
}());
